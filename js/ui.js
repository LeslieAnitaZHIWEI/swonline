// join channel modal
var agoraAppId = JSON.parse(getCookie(getQueryVariable("id"))).appId;
var roomId = JSON.parse(getCookie(getQueryVariable("id"))).roomId;
console.log(agoraAppId, "agoraAppId");
$("#refrsh-btn").click(function (event) {
  // var agoraAppId = $('#form-appid').val();
  leaveChannel();

  initClientAndJoinChannel(agoraAppId, JSON.parse(getCookie(getQueryVariable("id"))).roomId);
});
...
//   initClientAndJoinChannel(agoraAppId, channelName);
// });
$("#join-channel2").click(function (event) {
  // var agoraAppId = $('#form-appid').val();
  leaveChannel();
  console.log("??");
